    ...
    <section className="space-y-20 px-4 py-10 max-w-7xl mx-auto">
      ...
      <div className="text-center space-y-6">
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900">
          À propos de DigiNova Solutions
        </h1>
      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg">
        ...
        <p className="text-gray-600 text-lg leading-relaxed">
          L’objectif de DigiNova Solutions est d’offrir aux entreprises des solutions technologiques
          complètes et de permettre aux jeunes stagiaires d’acquérir une expérience pratique dans
          toutes les technologies du numérique. DigiNova ambitionne de devenir un centre d’excellence
